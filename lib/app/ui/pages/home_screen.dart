    ...
    return Scaffold(
      ...
      body: Consumer<AgendamientosModel>(
        builder: (context, agendamientosModel, child) {
          ...
          List<Agendamiento> turnosFuturos = agendamientosModel.agendamientos
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    FutureBuilder<PronosticoLluvia?>(
                      future: probPrecipitacion(agendamiento.fecha.toLocal()),
                          ...
                          actions: [
                            ...
                            TextButton(
                              onPressed: () {
                                ...
                                agendamientosModel.borrarAgendamiento(index);
                                Get.back(); // Cierra el AlertDialog
                              },
                              child: const Text(
                                "Sí",
